...
생성시각: 2026-07-31T19:14:33.220156+09:00
기준일: 20260730
...
|---|---|---:|---:|---|
| KRX Open API | direct_api | loaded | 160193 | - |
| OpenDART | direct_api | ok: transaction_docs 29, counterparties 27 | 28 | - |
| data.go.kr FSC | direct_api | ok: 2650 stocks, source_date 20260730 | 2650 | - |
| data.go.kr FTC | direct_api | ok: 387 listed companies, public_ym 202605 | 387 | - |
| data.go.kr FSC approved | direct_api | ok: financial_company_basic 93 companies, bond_basic 0 rows, bond_issue 0 rows, international_dr_item 0 rows, general_commodity_price 2 rows | 5 | - |
...
| FnGuide public page | public_page_cache | ok: 2604 stocks | 2642 | public_page_fragility |
