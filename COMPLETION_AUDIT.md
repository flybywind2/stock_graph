...
생성시각: 2026-05-28T10:27:29.255266+09:00
기준일: 20260521
...
| source_coverage | free_core | verified | SOURCE_COVERAGE.json, SOURCE_COVERAGE.md | bigkinds_direct_api_gap, kind_direct_api_gap, ksd_seibro_direct_api_gap, paid_provider_direct_api_gap |
...
| direct_api_completion | external_direct_api | blocked_external_dependency | SOURCE_COVERAGE.json, EXTERNAL_DEPENDENCY_AUDIT.json, EXTERNAL_API_READINESS.json, EXTERNAL_API_READINESS.md, EXTERNAL_API.env.example, EXTERNAL_API_LIVE_RUNBOOK.md, DATA_SOURCE_ACCESS_REQUIREMENTS.md | bigkinds_direct_api_gap, kind_direct_api_gap, ksd_seibro_direct_api_gap, paid_provider_direct_api_gap |
