...
생성시각: 2026-05-28T17:45:54.041948+09:00
기준일: 20260521
...
|---|---|---|---|---|---|---|---|---|---:|---|---:|---:|---:|---|---|
| bigkinds_direct_api_gap | BIGKinds | blocked_external_dependency | BIGKinds OpenAPI access_key 발급 후 tools.kinds.or.kr POST JSON endpoint 응답 레이아웃 확인 | --bigkinds-snapshots | return_object.documents | article_id, title, published_at, entities, keywords | Event, Evidence, positive_exposure, negative_exposure | BIGKINDS_API_KEY | False | BIGKINDS_API_URL | True | True | False | credential_missing | full_100_direct_api |
